...
/* harmony import */ var _services_auth_orders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @services/auth/orders */ "./resources/js/services/auth/orders.js");
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _services_auth_orders__WEBPACK_IMPORTED_MODULE_1__["default"].getStripeIntentDetails(_this2.$route.params.id).then(function (e) {
                  if (e) {
                    if (e.amount) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_1__["default"].updateQty(_this3.invoice.id, _this3.selectedItem);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                _context4.next = 6;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_1__["default"].captureOrder(_this4.invoice.id);

              case 6:
                res = _context4.sent;

                if (!res.status) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire("Error!", res.data, "error");
                } else {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire("Success!", "Your order has been charged.", "success");
                }
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                _context5.next = 6;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_1__["default"].voidOrder(_this5.invoice.id);
              ...
              case 6:
                ...
                if (!res.status) {
                  ...
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire("Success!", "Your order has been voided.", "success");
                }
...
var ordersservice = /*#__PURE__*/function () {
  ...
  _createClass(ordersservice, [{
    key: "updateQty",
    value: function () {
      var _updateQty = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(oid, item) {
        var res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
    ...
    value: function () {
      var _getStripeIntentDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(oid) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: "captureOrder",
    value: function () {
      var _captureOrder = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(oid) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "voidOrder",
    value: function () {
      var _voidOrder = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(oid) {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                            ...
                            _c(
                              ...
                              _vm._l(_vm.invoice.products, function (item) {
                                return _c("tr", { key: item.id }, [
                                  ...
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("PKR " + _vm._s(item.rowtotal)),
                                  ]),
                                ])
                              }),
                              0

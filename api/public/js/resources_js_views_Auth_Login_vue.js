...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    dologin: function () {
      var _dologin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _services_auth_login__WEBPACK_IMPORTED_MODULE_0__["default"].dologin(this.loggedinemail, this.loggedinpassword);

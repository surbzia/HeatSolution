      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/project'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('?perpage=0').then(function (e) {
                return e.data;
              });

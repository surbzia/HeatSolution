...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/chat'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var socket = io("https://obsessiondigitalradio.com/chat");
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['curuser', 'user'],
  watch: {
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/chat'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(head_id, _this2.message_search);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/chat'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_this3.curuser);
    ...
    onScroll: function onScroll(e) {
      if (this.loadingMessages == false && Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/chat'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())() == true) {
        var objDiv = document.getElementsByClassName("chat_row")[0];
        ...
        if (e.keyCode == 13 && e.shiftKey == true) {//let it line break
          ...
          if (this.allowMessages) {
            if (document.getElementsByClassName('message_area_editor')[0].innerText) {
              ...
              Object(function webpackMissingModule() { var e = new Error("Cannot find module '@services/auth/chat'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.head_id, formData);
